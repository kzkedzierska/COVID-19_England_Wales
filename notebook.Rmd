...
subtitle: "ONS data up to 03/04/2020"
...
All the comparisons between previous years (in the earlier parts of this notebook) are done based on figures from `ONS deaths by date of registration – registered by 27th March` set for compatibility with earlier datasets.
...
label_postions <- 
  ...
  mutate(fixed_position_cum = 2000 + 350 * 1:length(col_scheme),
         fixed_position_daily = 37 5+ 50 * 1:length(col_scheme))
...
There is more deaths among Males than Females. There were no deaths in the age groups not shown at the time. 
